        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupUserId = table.Column<string>(maxLength: 450, nullable: true),
                    RestaurantId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pickup_AspNetUsers_PickupUserId",
                        column: x => x.PickupUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pickup_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuPrices_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuPrices_MenuItemId",
                table: "MenuPrices",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_PickupId",
                table: "Order",
                column: "PickupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pickup_PickupUserId",
                table: "Pickup",
                column: "PickupUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Pickup_RestaurantId",
                table: "Pickup",
                column: "RestaurantId");
        }
