...
namespace chuloon.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Url,ImageUrl")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Url,ImageUrl")] Restaurant restaurant)
        {
            if (id != restaurant.Id)
            {
                return NotFound();
